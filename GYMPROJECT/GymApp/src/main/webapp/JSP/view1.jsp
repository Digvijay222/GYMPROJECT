...
<style>
    ...
    /* Color Variables */
:root {
    --primary-dark: #1e293b; /* Dark Indigo/Blue for sidebar and card background */
    --secondary-dark: #2d3748; /* Slightly lighter dark for inputs/buttons in dark card */
...
.header-logo {
    ...
    content: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="%23FFFFFF"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h-2zM9 11h2v2H9zM13 11h2v2h-2zM9 15h6v2H9z"/></svg>');
}
        ...
        <main class="main-content">
            ...
            <div class="members-panel">
                ...
                <div class="controls-row">
                    <label class="show-entries-label">Show entities 
                        <select>
                            <option>1</option>
                            <option>2</option>
                        </select>
                ...
                <table class="members-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>25</td>
                            <td>6.5</td>
                            <td><button class="action-btn"><a href="#">Edit</a></button></td>
