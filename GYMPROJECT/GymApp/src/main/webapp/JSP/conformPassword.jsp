        ...
        <div class="login-card">
            ...
            <form class="reset-form">
                ...
                <div class="input-group password-group">
                    <input type="password" placeholder="Enter New Password" required id="new-password">
                    <i class="fas fa-eye-slash toggle-password" data-target="new-password"></i>
                </div>

                <div class="input-group password-group">
                    <input type="password" placeholder="Confirm New Password" required id="confirm-password">
                    <i class="fas fa-eye-slash toggle-password" data-target="confirm-password"></i>
                </div>
                
                <button type="submit" class="continue-button"><a href="dashboard.jsp">Continue to Login</a></button>
            </form>
        </div>
    </div>
